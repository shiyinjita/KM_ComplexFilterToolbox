function H = bessel_filt(ni,wp,ap)
%   H = bessel_filt(ni,wp,ap) designs a Bessel filter having attenuation
...
% ap = -ap; % For consistency, the passband attenuation is specified as a positive number
H1 = BesselFltr(ni);
w = 1;
