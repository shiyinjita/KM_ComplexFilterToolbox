function [p, px, wp, ws, as, sclFctr, shftFctr] = trnsfrmD(p, px, wp, ws, as)
%   [p, px, wp, ws, as, sclFctr, shftFctr] = trnsfrmD(p, px, wp, ws, as)
%   shift digital specs to 0, predistorts for a bilinear transform and then
%   scales passband frequencies wp to -1,1
%
