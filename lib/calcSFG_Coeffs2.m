function coeffs = calcSFG_Coeffs2(elem1, elem2, elem3, G1, GF)
% calcSFG_Coeffs2() is a helper program to convert from Lddr elems to parameters needed for an AC simulation
...
% first and last stage, G1, G2, and GF are zero, as all intermediate stages do not dissipate power.
%
