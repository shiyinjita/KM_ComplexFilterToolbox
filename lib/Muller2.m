function [val table]= Muller2(strEqn, strVar, p0, p1, p2, tol, n)
%  [val table]= muller(strEqn, strVar, p0, p1, p2, tol, n) finds roots using Muller method
%  MULLER uses the Mullers method to solve for a root of f(x)
%
...
%
%  Original Code By: Jonathan Lister (jlister1@utk.edu)
%  Significantly modified by Kenneth Martin (martin@granitesemi.com)
%
% Additonal Examples
% 
