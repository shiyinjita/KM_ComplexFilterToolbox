...
%   zmin = find_minima(sys,ws,as,wp) finds the stop-band attenuation minima
...
% wmin = z2s(zmin,wp)
%
% KM: this was written in 2003. At 2018, I noticed this is returning with iterating for the minima
% as best I can tell, this is working properly. For now (8/20/18), I am not taking out the following
% code until I have time to investigate further; currently I need to move forward through correcting docs
...
%
%display('In find_minima(), nb iter: %d');
%
%i
% zmin.' % just for debug
