% This example was an early attempt at designing SS ladder filters; it works but has high sensitivities
% the cascade filter is fine
% the ladder approach, although high sensitivity does illustrate some SFG approaches
